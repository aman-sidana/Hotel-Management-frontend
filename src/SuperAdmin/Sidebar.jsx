      ...
      <div>
        ...
        <div className="sidebar-header border-b border-slate-200 dark:border-slate-700/70 p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="inline-block px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-sky-100 text-sky-600 border border-sky-200 dark:bg-sky-500/20 dark:text-sky-400 dark:border-sky-500/30">
              Super Admin
            </span>
          </div>
